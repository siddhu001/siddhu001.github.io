...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Siddhant Arora</title>
  
  <meta name="author" content="Siddhant Arora">
...
<body>
  <table style="width:100%;max-width:800px;border:0px;border-spacing:0px;border-collapse:separate;margin-right:auto;margin-left:auto;"><tbody>
   ...
   I have been lucky to find the support of strong advisor in <a href="https://sites.google.com/view/shinjiwatanabe"> Prof. Shinji Watanabe</a>, with whom I have made some initial investigations in these directions.
              </p>
              <p>
                I am working with <a href="https://sites.google.com/view/shinjiwatanabe"> Prof Shinji Watanabe </a> on Spoken Language Understanding (SLU) with an emphasis on <a href="https://arxiv.org/abs/2106.15065">robust testing</a> of SOTA SLU models and creating an <a href="https://arxiv.org/pdf/2111.14706.pdf">open source benchmark</a> for various datasets. We are further interested in <a href="https://arxiv.org/pdf/2207.06670.pdf">enhancing semantic modeling</a> in SLU systems and performing intent classification for spoken conversations by capturing the context in which utterance is spoken.
              </p>
              <p>
                During my Master's, I worked with <a href="http://www.phontron.com/">Prof. Graham Neubig</a>, <a href="https://www.zacharylipton.com/">Prof. Zachary Lipton</a> and <a href="http://www.cs.cmu.edu/~wcohen/">William Cohen</a> at Google AI on research projects involving rethinking user study design for evaluating explanations. This research taught me the importance of generating better interpretability frameworks and more actionable explanations. I also worked with <a href="https://www.normsadeh.org/">Prof. Norman Sadeh</a> at the <a href="https://usableprivacy.org/">Usable Privacy Policy Project</a> to empower internet users to take back control of their privacy.
              </p>
              <p>
              Previously, I was an undergrad at IIT Delhi, where I worked with <a href="https://www.cse.iitd.ac.in/~srikanta/">Prof. Srikanta Bedathur</a> on applying machine learning to the structured text, i.e., knowledge bases and relational databases. During my undergrad, I got an opportunity to work as a research scholar at Max Planck Institute of Informatics in the field of Neural Information Retrieval with <a href="https://andrewyates.net/">Prof. Andrew Yates</a>. I have also interned at <a href="https://research.adobe.com/">Adobe Research</a> Labs, Bangalore on toxic speech detection and <a href="https://www.anu.edu.au/">Australia National University</a> with <a href="http://users.cecs.anu.edu.au/~Tom.Gedeon/">Prof. Tom Gedeon</a> on Emotion Recognition.
              </p>
              <p>
              ...
              <p style="text-align:center">
                <a href="mailto:siddhantarora1806@gmail.com">Email</a> &nbsp/&nbsp
                <a href="data/Resume_Siddhant_Arora.pdf">CV</a>  &nbsp/&nbsp
                <a href="https://scholar.google.co.in/citations?user=VGfczTIAAAAJ&hl=en">Google Scholar</a> &nbsp/&nbsp
                <a href="https://www.linkedin.com/in/arora-sid/">LinkedIn</a> &nbsp/&nbsp
                <a href="https://twitter.com/Sid_Arora_18">Twitter</a> &nbsp/&nbsp
                <a href="https://github.com/siddhu001">Github</a>
              </p>
            </td>
            <td style="padding:2.5%;width:100%;height:100%;max-width:100%">
              <a href="images/Siddhant_Arora.jpg"><img height="height:100%" alt="profile photo" src="images/Siddhant_Arora.jpg" class="hoverZoomLink"></a>
            </td>
          </tr>
        </tbody></table>
        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="20"><tbody>
          <tr>
            <td>
              <heading>Peer-Reviewed Publications and Papers in Submission</heading>
            </td>
          </tr>
        </tbody></table>
        <table style="width:100%;border:0px;border-spacing:0px;border-collapse:separate;margin-right:auto;margin-left:auto;"><tbody>
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://arxiv.org/pdf/2111.14706.pdf">
                <papertitle>ESPnet-SLU: Advancing Spoken Language Understanding through ESPnet </papertitle>
              </a>
              <br>

              <b>Siddhant Arora</b>, Siddharth Dalmia, Pavel Denisov, Xuankai Chang, Yushi Ueda, Yifan Peng, Yuekai Zhang, Sujay Kumar, Karthik Ganesan, Brian Yan, Ngoc Thang Vu, Alan W Black, Shinji Watanabe
              <br>
              <em>ICASSP</em>, 2022
              <br>
              <a href="https://espnet-slu.github.io/">project page</a> /
              <a href="https://github.com/espnet/espnet">Github</a> /
              <a href="https://huggingface.co/spaces/Siddhant/ESPnet2-SLU">Demo</a>
              <p></p>
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://arxiv.org/pdf/2207.06670.pdf">
                <papertitle>Two-Pass Low Latency End-to-End Spoken Language Understanding </papertitle>
              </a>
              <br>

              <b>Siddhant Arora</b>, Siddharth Dalmia,  Xuankai Chang, Brian Yan, Alan W Black, Shinji Watanabe
              <br>
              <em>INTERSPEECH</em>, 2022
              <br>
              <a href="https://espnet-slu.github.io/two-pass">project page</a> /
              <a href="https://github.com/espnet/espnet">Github</a>
              <p></p>
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://arxiv.org/abs/2112.09669">
                <papertitle>Explain, Edit, and Understand:  Rethinking User Study Design for Evaluating Model Explanations </papertitle>
                </a>
              <br>

              <b>Siddhant Arora</b>*, Danish Pruthi*, Norman Sadeh, William W. Cohen, Zachary C. Lipton, Graham Neubig
              <br>
              <em>AAAI</em>, 2022
              <br>
              <a href="https://siddhu001.github.io/projects/evaluate_explanation.html">project page</a> /
              <a href="https://siddhu001.github.io/projects/AAAI_video_demo.mp4">video</a> 
              <!-- / -->
              <!-- <a href="https://github.com/maseEval/mase">Github</a> -->
              <p></p>
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://arxiv.org/abs/2106.15065">
                <papertitle>Rethinking End-to-End Evaluation of Decomposable Tasks: A Case Study on Spoken Language Understanding </papertitle>
              </a>
              <br>

              <b>Siddhant Arora</b>*, Alissa Ostapenko*, Vijay Viswanathan*, Siddharth Dalmia*, Florian Metze, Shinji Watanabe, Alan W Black
              <br>
							<em>InterSpeech</em>, 2021
              <br>
              <a href="https://maseeval.github.io/">project page</a> /
              <a href="https://www.youtube.com/watch?v=2lq0sS6mZjk&list=PL6liSIqFR4BUIjy9SfRY6ltghKMbGx7jE&index=35">video</a> /
              <a href="https://github.com/maseEval/mase">Github</a>
              <p></p>
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://usableprivacy.org/static/files/Arora_LREC_2022.pdf">
                <papertitle>A Tale of Two Regulatory Regimes: Creation and Analysis of a Bilingual Privacy Policy Corpus </papertitle>
                </a>
              <br>

              <b>Siddhant Arora</b>, Henry Hosseini, Christine Utz, Vinayshekhar Bannihatti Kumar, Tristan Dhellemmes, Abhilasha Ravichander, Peter Story, Jasmine Mangat, Rex Chen, Martin Degeling, Tom Norton, Thomas Hupperich, Shomir Wilson, Norman Sadeh
              <br>
              <em>LREC</em>, 2022
              <br>
              <a href="https://usableprivacy.org/">project page</a>
              <!-- / -->
              <!-- <a href="https://github.com/maseEval/mase">Github</a> -->
              <p></p>
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://openreview.net/pdf?id=fCQvGMT57w">
                <papertitle>IterefinE: Iterative KG Refinement Embeddings using Symbolic Knowledge </papertitle>
              </a>
              <br>

              <b>Siddhant Arora</b>, Srikanta Bedathur, Maya Ramnath, Deepak Sharma
              <br>
              <em>AKBC</em>, 2020
              <br>
              <a href="https://www.cse.iitd.ac.in/~srikanta/publication/akbc-20/">project page</a> /
              <a href="https://www.cse.iitd.ac.in/~srikanta/publication/akbc-20/akbc-20-slides.pdf">slides</a> /
              <a href="https://github.com/data-iitd/IterefinE">Github</a>
              <p></p>
              <p>
              Utilized probabilistic soft logic for removing noise from Knowledge graph based on ontology and Knowledge Graph embedding for inferring new facts together in a feedback manner.
					...
					<tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://dl.acm.org/doi/10.1145/3336191.3371868">
                <papertitle>Capreolus: A Toolkit for End-to-End Neural Ad Hoc Retrieval </papertitle>
              </a>
              <br>

              Andrew Yates, <b>Siddhant Arora</b>, Xinyu Zhang, Wei Yang, Kevin Martin Jose, Jimmy Lin
              <br>
              <em>WSDM</em>, 2020 Demo Track
              <br>
              <a href="https://github.com/capreolus-ir/capreolus">Github</a>
              <p></p>
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://kr2ml.github.io/2019/papers/KR2ML_2019_paper_55.pdf">
                <papertitle>On Embeddings in Relational Database </papertitle>
              </a>
              <br>

              <b>Siddhant Arora</b>, Srikanta Bedathur
              <br>
              <em>NeurIPS</em>, 2019 KR2ML Workshop
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="http://ceur-ws.org/Vol-2360/paper4Axiomatic.pdf">
                <papertitle>Investigating Ad-Hoc Retrieval Method Selection with Features Inspired by IR Axioms </papertitle>
              </a>
              <br>

              <b>Siddhant Arora</b>, Andrew Yates
              <br>
              <em>ECIR</em>, 2019 AMIR Workshop
              <br>
              <a href="https://github.com/capreolus-ir/capreolus">Github</a>
              <p></p>
              <p>
          ...
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="https://arxiv.org/abs/2007.12374">
                <papertitle>A survey on Graph Neural Network for Knowledge Graph Completion </papertitle>
              </a>
              <br>
              ...
              <em>Arxiv</em>, 2020
              <p>
              Understand the various strengths and
weaknesses of the proposed methodology based on GNN for Knowledge Graph Completion and
try to find new exciting research problems in
this area that require further investigation.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:10px;width:75%;vertical-align:middle">
              <a href="http://ceur-ws.org/Vol-2327/IUI19WS-HUMANIZE-3.pdf">
                <papertitle>Understanding Community Rivalry on Social Media: A Case Study of Two Footballing Giants </papertitle>
              </a>
              <br>

              Sopan Khosla, <b>Siddhant Arora</b>, Abhilash Nandy, Ankita Saxena, Anandhavelu N
              <br>
              <em>IUI</em>, 2019 HUMANIZE Workshop
              <p>
...
Under an Unknown Illumination</papertitle>
      ...
      <tbody><tr>
          ...
          <p align="left">
            <font size="2">
            Last Updated: <i><b>Nov. 16, 2021</b></i>
            </font>
